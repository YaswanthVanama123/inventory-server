...
/**
 * Debug Script: CustomerConnect Selector Inspector
 * This script logs into CustomerConnect and prints the HTML structure
 * of the orders list to help identify the correct CSS selectors.
 */
...
async function debugSelectors() {
  ...
  try {
    ...
    // Step 3: Get first order row HTML
